        ...
        <div className="h-full rounded-3xl shadow-lg bg-[#3a3a3a] shadow-black flex flex-col lg:flex-row w-full">
          <div className="left-bg rounded-l-xl lg:rounded-l-3xl max-lg:rounded-3xl lg:p-10 bg-[#3a3a3a] flex-1 relative">
            ...
            <div className="text-white lg:flex h-full">
              <h4 className="lg:text-4xl max-lg:mt-5 max-lg:ml-5 lg:absolute max-lg:text-lg bg-[#e7801f] px-4 pt-1 rounded-full w-fit">
                Graphify
              </h4>{" "}
              <br />
              <p className="drop-shadow-2xl lg:justify-center lg:items-center lg:m-auto  max-lg:ml-2 max-lg:mr-2 lg:w-[100%] max-lg:text- lg:text-2xl">
                Infuse creativity and purpose into visual elements, shaping your
                brand identity for a lasting impression.
              </p>
              <button className="absolute bottom-0 max-lg:text-sm right-0 max-lg:mb-2 max-lg:mr-1 lg:mb-4 lg:mr-4 duration-500 hover:bg-[#ffae62] shadow-black bg-[#e7801f] transition-all rounded-full p-2">
                Go
              </button>{" "}
